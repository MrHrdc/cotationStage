...
<div class="col-md-6">
              ...
              <select class="form-control" name="service" id="inputservice">
                ...
                <option value="service">service Achats Locaux</option>
                <option value="service">service Maintenance Routes</option>
                <option value="service">service Expliotation Routes</option>
                <option value="service">service Expliotation et Programmation</option>
                <option value="service">service inspection, Controle et Protection des Infrastructures Routieres</option>
                <option value="service">service Environnement</option>
                <option value="service">service Chef du Personnel </option>
                <option value="service">service Comptabilite Provinciale</option>
                <option value="service">service Comptable</option>
                <option value="service">service caissier</option>
                <option value="service">service Assistants Techniques Route</option>
                <option value="service">service Assistants Techniques Bacs</option>
