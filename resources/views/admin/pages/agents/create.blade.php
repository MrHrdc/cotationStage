          ...
          <form method="POST" action="{{ route('agents.store') }}">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="inputMatricule" name="matricule" required>
              </div>
              <div class="col-md-6">
                <label for="inputGrade" class="form-label">Grade</label>
                <input type="text" class="form-control" id="inputGrade" name="grade" required>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <label for="inputService" class="form-label">Service</label>
                <input type="text" class="form-control" id="inputService" name="service" required>
              </div>
              <div class="col-md-6">
