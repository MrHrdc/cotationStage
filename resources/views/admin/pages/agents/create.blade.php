...
<div class="col-md-6">
              ...
              <select class="form-control" name="service" id="inputservice">
                ...
                <option value="service">Recherches physico-Chimiques</option>
                <option value="service">Administration et finances</option>
                <option value="service">Recherches Geotechniques</option>
                <option value="service">Etudes, programmation et suivi travaux construction Rehabilitation </option>
                <option value="service">Electromecanique</option>
                <option value="service">Exploitation et Armement Bacs</option>
                <option value="service">Maintenaces Bacs</option>
                <option value="service">Administartif</option>
                <option value="service">comptabilite et tresorerie</option>
                <option value="service">Magasin Materiels Bacs</option>
                <option value="service">Etudes</option>
